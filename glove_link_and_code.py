...
if __name__ == "__main__":
    ...
    # --db glove1M --indexkey OPQ10_100,HNSW32_PQ10 --indexfile graph_data/glove1M_OPQ10_100_PQ10.index --beta_nsq 1 --beta_k 1 --beta_centroids quantazition_data/glove1M_OPQ10_100.npy --neigh_recons_codes quantazition_data/glove1M_OPQ10_100_codes.npy --k_reorder 0 --efSearch 1,2,4,8,16,32,64,96,128,160,192,224,256,320,384,400
    # --db glove1M --indexkey OPQ25_100,HNSW32_PQ25 --indexfile graph_data/glove1M_OPQ25_100_PQ25.index --beta_nsq 1 --beta_k 1 --beta_centroids quantazition_data/glove1M_OPQ25_100.npy --neigh_recons_codes quantazition_data/glove1M_OPQ25_100_codes.npy --k_reorder 0 --efSearch 1,2,4,8,16,32,64,96,128,160,192,224,256,320,384,400
    # --db glove1M --indexkey OPQ50_100,HNSW32_PQ50 --indexfile graph_data/glove1M_OPQ50_100_PQ50.index --beta_nsq 1 --beta_k 1 --beta_centroids quantazition_data/glove1M_OPQ50_100.npy --neigh_recons_codes quantazition_data/glove1M_OPQ50_100_codes.npy --k_reorder 0 --efSearch 1,2,4,8,16,32,64,96,128,160,192,224,256,320,384,400
    ...
    data_log = load_json("data_log_glove.json")
    data_log['hnsw_opq'] = {}
    ...
    for k_reorder in k_reorders:
        ...
        for efSearch in efSearchs:
            ...
            data_log['hnsw_opq']['search_time'].append(ans)
