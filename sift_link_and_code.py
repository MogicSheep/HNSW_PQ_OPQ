...
if __name__ == "__main__":
    ...
    # --db sift1M --indexkey OPQ16_128,HNSW32_PQ16 --indexfile graph_data/sift1M_OPQ16_32_PQ16.index --beta_nsq 1 --beta_k 1 --beta_centroids quantazition_data/sift1M_OPQ16_32_PQ16.npy --neigh_recons_codes quantazition_data/sift1M_OPQ16_32_PQ16_codes.npy --k_reorder 0 --efSearch 5,8,16,32,64,96,128,160,192,224,256,320,384,400

    # --db sift1M --indexkey OPQ32_128,HNSW32_PQ32 --indexfile graph_data/sift1M_OPQ32_128_PQ32.index --beta_nsq 1 --beta_k 1 --beta_centroids quantazition_data/sift1M_OPQ32_128_PQ32.npy --neigh_recons_codes quantazition_data/sift1M_OPQ32_128_PQ32_codes.npy --k_reorder 0 --efSearch 5,8,16,32,64,96,128,160,192,224,256,320,384,400

    # --db sift1M --indexkey OPQ64_128,HNSW32_PQ64 --indexfile graph_data/sift1M_OPQ64_128_PQ64.index --beta_nsq 1 --beta_k 1 --beta_centroids quantazition_data/sift1M_OPQ64_128_PQ64.npy --neigh_recons_codes quantazition_data/sift1M_OPQ64_128_PQ64_codes.npy --k_reorder 0 --efSearch 5,8,16,32,64,96,128,160,192,224,256,320,384,400
    ...
    aa('--efConstruction', default=40, type=int,
    ...
    data_log = load_json("data_log_sift.json")
    data_log['hnsw_opq64'] = {}
    data_log['hnsw_opq64']['search_time'] = []
    ...
    for k_reorder in k_reorders:
        ...
        for efSearch in efSearchs:
            ...
            hnsw_stats.reset()
            ans = datasets.evaluate(xq, gt, index, efSearch)
            data_log['hnsw_opq64']['search_time'].append(ans)
            print("ndis %d nreorder %d" % (hnsw_stats.ndis, hnsw_stats.nreorder))

    save_json(data_log, "data_log_sift.json")
